...
impl CorruptionTestFixture {
    ...
    async fn verify_corruption_detected(&self, offset: usize) -> Result<()> {
        ...
        self.persistence
            .corrupt_file_content(file_id, 1, offset, corrupt_byte)
            .await?;
        ...
        self.persistence
            .corrupt_file_content(file_id, 1, offset, self.config.fill_byte)
            .await?;
...
async fn test_corruption_first_block() -> Result<()> {
    ...
    persistence
        .corrupt_file_content(file_id, 1, 0, 0xFF)
        .await?;
...
async fn test_corruption_middle_block() -> Result<()> {
    ...
    persistence
        .corrupt_file_content(file_id, 1, 1500, 0xCC)
        .await?;
    ...
    assert!(
        read_result.is_err(),
        "Should detect corruption in middle block"
    );
...
async fn test_corruption_last_block() -> Result<()> {
    ...
    persistence
        .corrupt_file_content(file_id, 1, 32000, 0x11)
        .await?;
    ...
    assert!(
        read_result.is_err(),
        "Should detect corruption in last block"
    );
...
async fn test_corruption_block_boundary() -> Result<()> {
    ...
    persistence
        .corrupt_file_content(file_id, 1, 16384, 0x22)
        .await?;
    ...
    assert!(
        read_result.is_err(),
        "Should detect corruption at block boundary"
    );
...
async fn test_multiple_corruptions() -> Result<()> {
    ...
    persistence
        .corrupt_file_content(file_id, 1, 100, 0x44)
        .await?;
    persistence
        .corrupt_file_content(file_id, 1, 20000, 0x55)
        .await?;
    persistence
        .corrupt_file_content(file_id, 1, 50000, 0x66)
        .await?;
...
async fn test_every_byte_corruption_detected() -> Result<()> {
    ...
    for byte_offset in test_positions {
        // Corrupt one byte
        persistence
            .corrupt_file_content(file_id, 1, byte_offset, 0xFF)
            .await?;
        ...
        persistence
            .corrupt_file_content(file_id, 1, byte_offset, 0xAB)
            .await?;
    }
...
async fn test_series_corruption_first_version() -> Result<()> {
    ...
    persistence
        .corrupt_file_content(file_id, 1, 100, 0xFF)
        .await?;
    ...
    assert!(
        read_result.is_err(),
        "Should detect corruption in first version"
    );
...
async fn test_series_corruption_middle_version() -> Result<()> {
    ...
    persistence
        .corrupt_file_content(file_id, 2, 500, 0xFF)
        .await?;
    ...
    assert!(
        read_result.is_err(),
        "Should detect corruption in middle version"
    );
...
async fn test_series_corruption_last_version() -> Result<()> {
    ...
    persistence
        .corrupt_file_content(file_id, 3, 12000, 0xFF)
        .await?;
    ...
    assert!(
        read_result.is_err(),
        "Should detect corruption in last version"
    );
...
async fn test_series_corruption_at_version_boundary() -> Result<()> {
    ...
    persistence
        .corrupt_file_content(file_id, 1, 16383, 0xFF)
        .await?;
    ...
    assert!(
        read_result.is_err(),
        "Should detect corruption at version boundary"
    );
...
async fn test_series_small_versions_blake3_validation() -> Result<()> {
    ...
    persistence
        .corrupt_file_content(file_id, 5, 50, 0xFF)
        .await?;
    ...
    assert!(
        read_result.is_err(),
        "Should detect corruption even in small series (via cumulative validation)"
    );
...
async fn test_series_small_version_corruption_mid_block() -> Result<()> {
    ...
    persistence
        .corrupt_file_content(file_id, 5, 100, 0xFF)
        .await?;
    ...
    assert!(
        read_result.is_err(),
        "Should detect corruption in small version within block"
    );
...
async fn test_series_small_version_corruption_at_block_boundary() -> Result<()> {
    ...
    persistence
        .corrupt_file_content(file_id, 4, 1024, 0xFF)
        .await?;
    ...
    assert!(
        read_result.is_err(),
        "Should detect corruption at block boundary within version"
    );
...
async fn test_series_small_version_corruption_first() -> Result<()> {
    ...
    persistence
        .corrupt_file_content(file_id, 1, 50, 0xFF)
        .await?;
    ...
    assert!(
        read_result.is_err(),
        "Should detect corruption in first small version"
    );
...
async fn test_series_small_version_corruption_last() -> Result<()> {
    ...
    persistence
        .corrupt_file_content(file_id, 10, 50, 0xFF)
        .await?;
    ...
    assert!(
        read_result.is_err(),
        "Should detect corruption in last small version"
    );
...
async fn test_series_tiny_versions_corruption() -> Result<()> {
    ...
    assert!(
        read_result.is_err(),
        "Should detect corruption in tiny version via cumulative checksum"
    );
...
async fn test_series_exact_block_versions_corruption() -> Result<()> {
    ...
    persistence
        .corrupt_file_content(file_id, 3, 100, 0xFF)
        .await?;
    ...
    assert!(
        read_result.is_err(),
        "Should detect corruption in exact-block-sized version"
    );
...
async fn test_corruption_small_file_blake3_only() -> Result<()> {
    ...
    // Corrupt middle byte
    persistence
        .corrupt_file_content(file_id, 1, 500, 0xFF)
        .await?;
...
async fn test_corruption_exactly_one_block() -> Result<()> {
    ...
    assert!(
        read_result.is_err(),
        "Should detect corruption via blake3 fallback"
    );
...
async fn test_corruption_large_file_many_blocks() -> Result<()> {
    ...
    for offset in test_offsets {
        persistence
            .corrupt_file_content(file_id, 1, offset, 0xFF)
            .await?;
        ...
        persistence
            .corrupt_file_content(file_id, 1, offset, 0x99)
            .await?;
    }
...
async fn test_single_byte_file_corruption() -> Result<()> {
    ...
    assert!(
        read_result.is_err(),
        "Should detect corruption in 1-byte file via blake3"
    );
...
async fn test_minimal_second_block() -> Result<()> {
    ...
    persistence
        .corrupt_file_content(file_id, 1, 16384, 0xFF)
        .await?;
    ...
    assert!(
        read_result.is_err(),
        "Should detect corruption in minimal second block"
    );
...
async fn test_table_version_corruption_large() -> Result<()> {
    ...
    assert!(
        read_result.is_err(),
        "Should detect corruption in TablePhysicalVersion"
    );
...
async fn test_table_series_corruption_first_version() -> Result<()> {
    ...
    assert!(
        read_result.is_err(),
        "Should detect corruption in table series first version"
    );
...
async fn test_table_series_corruption_middle_version() -> Result<()> {
    ...
    assert!(
        read_result.is_err(),
        "Should detect corruption in table series middle version"
    );
...
async fn test_fixture_over_one_bao_block() -> Result<()> {
    let config =
        CorruptionTestConfig::small_file(16 * 1024 + 1).with_offsets(vec![0, 16383, 16384]); // Boundary testing
    let fixture = CorruptionTestFixture::setup(config).await?;
    fixture.run_all_corruption_tests().await
}
...
async fn test_fixture_under_large_threshold() -> Result<()> {
    let config = CorruptionTestConfig::small_file(63 * 1024).with_offsets(vec![
        0,
        16 * 1024,
        32 * 1024,
        48 * 1024,
...
async fn test_fixture_at_large_threshold() -> Result<()> {
    let config = CorruptionTestConfig::large_file(64 * 1024).with_offsets(vec![
        0,
        16 * 1024,
        32 * 1024,
        48 * 1024,
...
async fn test_fixture_large_128kb() -> Result<()> {
    let config = CorruptionTestConfig::large_file(128 * 1024).with_offsets(vec![
        0,              // First byte
...
async fn test_fixture_large_1mb() -> Result<()> {
    let config = CorruptionTestConfig::large_file(1024 * 1024).with_offsets(vec![
        0,
        256 * 1024,
        512 * 1024,
        768 * 1024,
...
async fn test_fixture_every_block_boundary() -> Result<()> {
    ...
    let config = CorruptionTestConfig::large_file(256 * 1024).with_offsets(offsets);
    let fixture = CorruptionTestFixture::setup(config).await?;
    fixture.run_all_corruption_tests().await
}
...
async fn test_large_file_first_chunk_corruption() -> Result<()> {
    ...
    assert!(
        read_result.is_err(),
        "Should detect corruption in first chunk of large file"
    );
...
async fn test_large_file_last_chunk_corruption() -> Result<()> {
    ...
    // Corrupt last byte
    persistence
        .corrupt_file_content(file_id, 1, 100 * 1024 - 1, 0xFF)
        .await?;
    ...
    assert!(
        read_result.is_err(),
        "Should detect corruption in last byte of large file"
    );
